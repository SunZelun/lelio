...
const api = {
  ...
  selectProjectFolder: () => invoke<void, FolderSelectResult>(IPC_CHANNELS.projectSelectFolder),
  analyzeProjectFolder: (input: ProjectAnalyzeInput) => invoke<ProjectAnalyzeInput, ProjectAnalysis>(IPC_CHANNELS.projectAnalyze, input),
